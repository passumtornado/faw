    		...
    		<div class="col-md-4">
    			<div class="card card-signup">
                    ...
                    <div class="social-line" style="">
                      <a href="#pablo" class="btn btn-just-icon btn-link btn-white">
                        <i class="far fa-facebook-square" style="color: blue;font-size: 24px;"></i>
                      </a>
                      <a href="#pablo" class="btn btn-just-icon btn-link btn-white">
                        <i class="fas fa-twitter" style="color: lightblue; font-size: 24px;"></i>
                      <div class="ripple-container"></div></a>
                      <a href="#pablo" class="btn btn-just-icon btn-link btn-white">
                        <i class="fas fa-google-plus" style="color: red; font-size: 24px;"></i>
                      </a>
                    </div>
    				</div>
    				<div class="card-body">
                <?php 
                  ...
                  require('database/connection.php');
                    if(isset($_POST['submit_supplier'])){
                      ...
                      // $hash_code = password_hash($password, PASSWORD_DEFAULT);
                        $query = "SELECT * FROM supplier WHERE (username = '$login' OR email ='$login' )";
                        ...
                        $isValid = password_verify($password, $pwd);
                         ...
                         $_SESSION['email']= $row['username'];
                          ...
                          echo  "
                               <div class='alert alert-warning'>
                                   <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b><p>Wrong username/email or password</p></b>
                                   </div>
                              ";
                        }
                  ...
                  ?>
                        ...
                        <h4 class="description text-center">supplier login forms</h4>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                            	 <button type="submit" class="btn btn-primary" name="submit_supplier" class="form-control" id="submit_farmer" style="float:right;">login</button>
