...
<body>
    ...
    <?php endif ?>
                    ...
                    <form method="post" action="farm_process.php">
                        ...
                        <div class="form-group bmd-form-group">
                             <button type="submit"  class="btn btn-primary btn-round" name="submit">Sign In</button>
                        </div>
                    </form>
                </div> 
                </div>
    ...
    <?php endif ?> 
                    ...
                    <form method="post" action="farm_process.php">
                        ...
                        <span>or use your account</span>
                        <div class="form-group bmd-form-group">
                            <label class="bmd-label-static">first name</label> <span id="validate"></span>
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" id="add" class="form-control" name="address" required>
                            <span class="validate"></span>
                        ...
                        <div class="form-group bmd-form-group">
                         ...
                         <div class="form-group bmd-form-group">
                            ...
                            <input type="password" id="pass1" class="form-control" name="confirm_password" required>
                            <span class="validate"></span>
                        </div>
                        <div class="form-group bmd-form-group">
                             <button type="submit" class="btn btn-primary btn-round" name="register">Register</button>
                        </div>
                    </form>
                </div> 
                </div>
