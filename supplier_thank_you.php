  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php?#login"><i class="material-icons">send</i>login</a>
        </li>
      </ul>
    </div>
  </div>
   ...
   <div class="row">
     <div class="col-md-2"></div>
      <div class="col-md-8">
        <div class="card">
          <div class="card-body">
            <h4 class="text-center text-success">Thank You for Registering....</h4>
             <p class="handshake"><i class="fas fa-handshake fa-4x"></i></p>
            <p class="text-center">On the Home page, you will now be able to login and access your dashboad.
              <a href="supplier_register.php">Click here to login</a></p>
          </div>
        </div>
      </div>
       <div class="col-md-2"></div>
